...
// Retrieve the total number of Quotations sent
$total_stmt = $conn->prepare("SELECT COUNT(*) as total FROM clients WHERE lead_status = 'Quotations Sent'");
$total_stmt->execute();
...
// Retrieve quotations sent leads with pagination
$stmt = $conn->prepare("SELECT * FROM clients WHERE lead_status = 'Quotations Sent' LIMIT ?, ?");
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h1 class="mt-4">Quotations Sent</h1>
            <div class="mb-3">
                <form method="GET" action="quotations-sent.php" class="form-inline">
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                            <a class="page-link" href="quotations-sent.php?limit=<?php echo $limit; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                        </li>
                        <?php endfor; ?>
