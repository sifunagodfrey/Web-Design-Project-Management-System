...
// Retrieve the total number of refused leads
$total_stmt = $conn->prepare("SELECT COUNT(*) as total FROM clients WHERE lead_status = 'Refused'");
$total_stmt->execute();
...
// Retrieve refused leads with pagination
$stmt = $conn->prepare("SELECT * FROM clients WHERE lead_status = 'Refused' LIMIT ?, ?");
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h1 class="mt-4">Refused Leads</h1>
            <div class="mb-3">
                <form method="GET" action="refused-leads.php" class="form-inline">
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                            <a class="page-link" href="refused-leads.php?limit=<?php echo $limit; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                        </li>
                        <?php endfor; ?>
