                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div id="webDesignDetails" class="proposal-details" style="display: none;">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="designProject" placeholder="Enter Project Name">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="designClient">Client Name</label>
                                        <input type="text" class="form-control" id="designClient" placeholder="Enter Client Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="designDescription">Project Description</label>
                                    <textarea id="designDescription" name="designDescription" class="form-control" rows="10"></textarea>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="designTimeline">Timeline</label>
                                        <input type="text" class="form-control" id="designTimeline" placeholder="Enter Timeline">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="designBudget">Estimated Budget</label>
                                        <input type="text" class="form-control" id="designBudget" placeholder="Enter Budget">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="digitalMarketingDetails" class="proposal-details" style="display: none;">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="marketingCampaign" placeholder="Enter Campaign Name">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="marketingClient">Client Name</label>
                                        <input type="text" class="form-control" id="marketingClient" placeholder="Enter Client Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="marketingObjectives">Campaign Objectives</label>
                                    <textarea id="marketingObjectives" name="marketingObjectives" class="form-control" rows="10"></textarea>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="marketingTimeline">Timeline</label>
                                        <input type="text" class="form-control" id="marketingTimeline" placeholder="Enter Timeline">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="marketingBudget">Estimated Budget</label>
                                        <input type="text" class="form-control" id="marketingBudget" placeholder="Enter Budget">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="proposalDueDate">
                            </div>
