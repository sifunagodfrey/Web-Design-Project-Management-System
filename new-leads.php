...
// Retrieve the total number of new leads
$total_stmt = $conn->prepare("SELECT COUNT(*) as total FROM clients WHERE lead_status = 'New'");
$total_stmt->execute();
...
// Retrieve new leads sorted by the most recent (based on created_at field)
$stmt = $conn->prepare("SELECT client_id, first_name, last_name, phone_number, lead_status, next_follow_up FROM clients WHERE lead_status = 'New' ORDER BY created_at DESC LIMIT ?, ?");
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h1 class="mt-4">New Leads</h1>
            <div class="mb-3">
                <form method="GET" action="new-leads.php" class="form-inline">
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                            <a class="page-link" href="new-leads.php?limit=<?php echo $limit; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                        </li>
                        <?php endfor; ?>
